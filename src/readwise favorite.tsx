...
export async function fetchHighlights({ name, state, count }: FetchBookmarksRequest = {}): Promise<Array<Highlight>> {
    ...
    const response = await api.get("v2/highlights?tagName=favorite", 
  ...
  export function useHighlights() {
    const { data, error, isValidating} = useSWR<Array<Highlight>, HTTPError>("v2/highlights?tagName=favorite", fetchHighlights);
