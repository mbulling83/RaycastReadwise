...
import { getPreferenceValues, showToast, ToastStyle, List} from "@raycast/api";
...
// the error seems to be here as this is what is making the call and awaiting the response
// Bookmark is maybe the next place to look
